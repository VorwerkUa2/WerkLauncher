...
GameOptions::GameOptions(const QString &path) : path(path) { reload(); }
...
int GameOptions::columnCount(const QModelIndex &) const { return 2; }

bool GameOptions::isLoaded() const { return loaded; }
...
bool GameOptions::save() { return ::save(path, contents, version); }
