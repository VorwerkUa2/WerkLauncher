...
VersionSelectDialog::VersionSelectDialog(BaseVersionList *vlist, QString title,
  ...
  titleBar->setTitle(title.isEmpty() ? tr("Choose Version") : title);
  m_verticalLayout->addWidget(titleBar);
...
void VersionSelectDialog::setResizeOn(int column) { resizeOnColumn = column; }
