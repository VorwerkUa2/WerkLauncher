...
NotificationDialog::NotificationDialog(
  ...
  titleBar->setTitle(tr("Notification"));
...
void NotificationDialog::on_dontShowAgainBtn_clicked() { done(DontShowAgain); }
void NotificationDialog::on_closeBtn_clicked() { done(Normal); }
