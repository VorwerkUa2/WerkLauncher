...
QString LabeledToolButton::text() const { return m_label->text(); }

void LabeledToolButton::setText(const QString &text) { m_label->setText(text); }
...
QSize LabeledToolButton::sizeHint() const {
  ...
  */
  ...
  QSize rawSize =
      style()->sizeFromContents(QStyle::CT_ToolButton, &opt, QSize(w, h), this);
  return rawSize;
}
