...
QString DarkTheme::appStyleSheet() {
  ...
  QString qss =
      ...
      "border-radius: 8px; padding: 6px 14px; color: #ffffff; }"
      "QPushButton:hover, QToolButton:hover { background-color: #333333; "
      "border: 1px solid "
      "#ffae00; color: #ffae00; }"
      "QToolButton { spacing: 48px; }"
      "QToolButton:on, QToolButton:open { background-color: #333333; "
      "border: 1px solid #444444; }"
      "QPushButton:pressed, QToolButton:pressed { background-color: "
      "#1a1a1b; border: 1px solid #ffae00; padding: 7px 13px 5px 15px; }"
