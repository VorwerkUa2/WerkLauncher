...
void JavaWizardPage::refresh() { m_java_widget->refresh(); }

void JavaWizardPage::initializePage() { m_java_widget->initialize(); }

bool JavaWizardPage::wantsRefreshButton() { return true; }
...
void JavaWizardPage::retranslate() {
  // Title hidden to avoid overlap with custom title bar
  // setTitle(tr("Java"));
  // setSubTitle(tr(
