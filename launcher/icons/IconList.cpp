...
IconList::IconList(const QStringList &builtinPaths, QString path,
  ...
  QStringList builtinList = builtinNames.values();
  builtinList.sort();
...
int IconList::rowCount(const QModelIndex &parent) const { return icons.size(); }
...
QString IconList::getDirectory() const { return m_dir.absolutePath(); }
